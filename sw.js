const CACHE='cp-v32-0-0';
const STATIC=[
  './styles.css?v=32.0.0','./data.js?v=32.0.0','./app.js?v=32.0.0','./pc-log.js?v=32.0.0',
  './map.png','./manifest.webmanifest?v=32.0.0','./icon-192.png','./icon-512.png','./reset-cache.html'
];
